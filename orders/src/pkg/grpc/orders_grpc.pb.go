...
func (c *ordersClient) CreateOrder(ctx context.Context, in *NewOrder, opts ...grpc.CallOption) (*emptypb.Empty, error) {
...
func (UnimplementedOrdersServer) CreateOrder(context.Context, *NewOrder) (*emptypb.Empty, error) {
...
func _Orders_CreateOrder_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrdersServer).CreateOrder(ctx, req.(*NewOrder))
	}
...
var Orders_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "src/pkg/grpc/orders.proto",
}
